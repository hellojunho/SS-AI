...
class _ChatHistoryScreenState extends State<ChatHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    final dates = _dates?.dates ?? const <String>[];
    final today = _dates?.today ?? 'Null';
    return Scaffold(
                        ...
                        ...dates.map(
                          (date) => Card(
                            child: ListTile(
                              ...
                              title: Text(date),
                              subtitle: Text(date == today ? '오늘 대화' : '저장된 대화'),
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
...
class _ChatHistoryDetailScreenState extends State<ChatHistoryDetailScreen> {
  ...
  @override
  Widget build(BuildContext context) {
    final entries = _history?.entries ?? const <ChatHistoryEntry>[];
    return Scaffold(
